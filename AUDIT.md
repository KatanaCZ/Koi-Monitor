...
- **OK** — CI Release (tag `v*`) : build exe + notes **`### Pour vous`** via `extract-release-notes.ps1` (~3–8 min cache warm)
- **OK** — Changelog dual **Pour vous** / **Détail technique** + `docs/marketing-context.md` (releases grand public)
